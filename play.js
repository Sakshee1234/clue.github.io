...
socket.addEventListener('message', (event) => {
  ...
  else if(m.data==4)
  {
    ...
    document.getElementById("dieimage").addEventListener('click',()=>{
  ...
  {
    document.getElementById("gamemessages").innerText="Player is playing";
  }
  else if(m.data==12 || m.data==13)
  {
    const pop=document.getElementById("popup");
    document.getElementById("pmsg").innerHTML="Player 1 has made a guess";
    console.log(m.ans[0]);
